// valid.js - Funciones globales de validación para pruebas técnico-mecánicas

// Configuración de rangos por tipo de prueba y por campo
...
// Función para validar todos los ejes de alineación
// function validarAlineacionCompleta() {
//     const ejes = ['eje1', 'eje2', 'eje3', 'eje4', 'eje5'];
//     let todosValidos = true;

//     ejes.forEach(eje => {
//         const valor = $(`#${eje}`).val();
//         if (valor && !validarRango(valor, 'alineacion', eje)) {
//             todosValidos = false;
//         }
//     });
...
// Función para validar frenos completos
// function validarFrenosCompleta() {
//     const camposFrenos = ['desequilibrio_eje1', 'desequilibrio_eje2', 'fuerza_frenado_eje1', 'fuerza_frenado_eje2', 'fuerza_auxiliar'];
//     let todosValidos = true;

//     camposFrenos.forEach(campo => {
//         const valor = $(`#${campo}`).val();
//         if (valor && !validarRango(valor, 'frenos', campo)) {
//             todosValidos = false;
//         }
//     });
